...
function DesignerComponent({ elementInstance }: { elementInstance: FormElementInstance }) {
  ...
  const { label, required, placeHolder, helperText, backgroundColor } = element.extraAttributes;
  return (
...
function PropertiesComponent({ elementInstance }: { elementInstance: FormElementInstance }) {
  ...
  const form = useForm<propertiesFormSchemaType>({
    ...
    defaultValues: {
      ...
      backgroundColor: element.extraAttributes.backgroundColor, // Default background color
    },
  });
  ...
  function applyChanges(values: propertiesFormSchemaType) {
    const { label, helperText, placeHolder, required, backgroundColor } = values;
